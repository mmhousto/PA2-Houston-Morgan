...
# AIFCA Python3 code Version 0.7.4 Documentation at http://aipython.org
    ...
    def search_with_var_pq(self,max_steps, prob_best=1.0, prob_anycon=1.0):
        ...
        for i in range(max_steps):
            ...
            if len(self.csp.domains[var]) > 1:   # var has other values
                ...
                self.display(2,self.number_of_steps,": Number of conflicts",len(self.conflicts))
...
from cspExamples import csp1, csp2, crossword1b

## Test Solving CSPs with Search:
#se1 = SLSearcher(crossword1b); print(se1.search(100))
...
#p = Runtime_distribution(crossword1b)
