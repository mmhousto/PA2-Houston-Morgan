...
from cspExamples import csp1, csp2, csp3, csp4, crossword1b, crossword1d
    
if __name__ == "__main__":
    test(ac_search_solver)

## Test Solving CSPs with Arc consistency and domain splitting:
Con_solver.max_display_level = 2  # display details of AC (0 turns off)
Con_solver(crossword1b).solve_one()
#Searcher.max_display_level = 0  # display search trace (0 turns off)
#searcher3c = Searcher(Search_with_AC_from_CSP(crossword1b))
#print(searcher3c.search())
#searcher5c = Searcher(Search_with_AC_from_CSP(crossword1d))
